// CapsImgS.h: interface for the CCapsImageStd class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_CAPSIMGS_H__1416805F_DC5F_4D6A_A041_247B2C5942F2__INCLUDED_)
#define AFX_CAPSIMGS_H__1416805F_DC5F_4D6A_A041_247B2C5942F2__INCLUDED_
...
protected:
	...
	uint32_t ReadBit(uint8_t *buf, uint32_t bitpos, int bitcnt);
	...
	static uint32_t GetByteSize(uint32_t bitsize);
...
inline uint32_t CCapsImageStd::GetByteSize(uint32_t bitsize)
{
	return ((bitsize+7) >> 3);
}

// read 1 data bit
inline uint32_t CCapsImageStd::ReadBit(uint8_t *buf, uint32_t bitpos)
{
	return buf[bitpos >> 3] >> ((bitpos & 7) ^ 7) & 1;
}

#endif // !defined(AFX_CAPSIMGS_H__1416805F_DC5F_4D6A_A041_247B2C5942F2__INCLUDED_)
